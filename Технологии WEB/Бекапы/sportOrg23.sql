...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 14 2024 г., 10:06
...
(15, 'Футбольный чемпионат 1', 2, 2, '2020-07-01', 15),
(16, 'Волейбольный кубок 1', 4, 3, '2020-08-15', 16),
(33, 'Баскетбольный турнир 11 norm', 4, 2, '2024-11-12', 33),
(34, 'lorem123ipsum', 3, 1, '2020-01-25', 34),
(38, 'Норм название и дата', 5, 3, '2022-05-25', 38),
(39, 'final proverka1337', 9, 3, '2024-11-13', 39);
...
ALTER TABLE `sorevnovaniya`
  ...
  ADD KEY `sorevnovaniya_prizer` (`id_prizer`) USING BTREE;
...
ALTER TABLE `sportsmen_prizer`
  ...
  ADD CONSTRAINT `sportsmen_prizer_ibfk_3` FOREIGN KEY (`id_sorevnovaniya`) REFERENCES `sorevnovaniya` (`id_prizer`);
